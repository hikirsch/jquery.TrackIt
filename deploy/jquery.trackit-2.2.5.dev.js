 ...
 */
var Void=function(){};
$.each(["groupCollapsed","groupEnd","group","warn","info","dir","warn","error","log"], function(i,s) { if (!( s in console ) ) { window.console[s] = Void; } });
/**
		...
		ReplaceHolders: function(str, key, options){
			...
			if( holders && skipHolders !== false ) { 
				...
				for (var index = 0; index < holders.length; index++) {
					...
					// now run this through again in case any of the holders we included have other holders in them
